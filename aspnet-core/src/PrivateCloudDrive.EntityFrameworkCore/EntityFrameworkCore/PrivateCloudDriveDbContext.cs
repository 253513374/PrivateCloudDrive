...
public class PrivateCloudDriveDbContext :
    AbpDbContext<PrivateCloudDriveDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(PrivateCloudDriveConsts.DbTablePrefix + "YourEntities", PrivateCloudDriveConsts.DbSchema);

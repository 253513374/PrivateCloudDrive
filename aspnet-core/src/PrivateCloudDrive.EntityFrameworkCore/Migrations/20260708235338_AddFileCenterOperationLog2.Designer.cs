...
namespace PrivateCloudDrive.Migrations
{
    ...
    [Migration("20260708235338_AddFileCenterOperationLog2")]
    partial class AddFileCenterOperationLog2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrivateCloudDrive.FileCenter.BlobObject", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppFileCenterBlobObjects", (string)null);
                });

            modelBuilder.Entity("PrivateCloudDrive.FileCenter.FileCenterOperationLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "FileNodeId");

                    b.HasIndex("TenantId", "OperatorUserId", "CreationTime");

                    b.ToTable("AppFileCenterOperationLogs", (string)null);
                });

            modelBuilder.Entity("PrivateCloudDrive.FileCenter.FileNode", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OwnerId", "ParentId", "NormalizedName")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false AND \"ParentId\" IS NOT NULL");

                    b.HasIndex("TenantId", "OwnerId", "IsFavorite");
            ...
            modelBuilder.Entity("PrivateCloudDrive.FileCenter.FileNodeTag", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "OwnerId", "TagId");

                    b.HasIndex("TenantId", "OwnerId", "FileNodeId", "TagId")
                        .IsUnique();

                    b.ToTable("AppFileCenterFileNodeTags", (string)null);
                });

            modelBuilder.Entity("PrivateCloudDrive.FileCenter.FileShare", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "OwnerId", "FileNodeId");

                    b.ToTable("AppFileCenterFileShares", (string)null);
                });

            modelBuilder.Entity("PrivateCloudDrive.FileCenter.FileTag", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "OwnerId", "NormalizedName")
                        .IsUnique();

                    b.ToTable("AppFileCenterFileTags", (string)null);
                });

            modelBuilder.Entity("PrivateCloudDrive.FileCenter.MediaAlbum", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("CoverFileNodeId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "OwnerId", "LastModificationTime");

                    b.HasIndex("TenantId", "OwnerId", "NormalizedName")
                        .IsUnique();

                    b.ToTable("AppFileCenterMediaAlbums", (string)null);
                });

            modelBuilder.Entity("PrivateCloudDrive.FileCenter.MediaAlbumItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AlbumId", "FileNodeId")
                        .IsUnique();

                    b.HasIndex("TenantId", "OwnerId", "AlbumId");

                    b.HasIndex("TenantId", "OwnerId", "FileNodeId");

                    b.ToTable("AppFileCenterMediaAlbumItems", (string)null);
                });
            ...
            modelBuilder.Entity("PrivateCloudDrive.FileCenter.MediaAsset", b =>
                {
                    ...
                    b.HasIndex("TenantId", "OwnerId", "ProcessStatus");

                    b.HasIndex("TenantId", "OwnerId", "TakenAt");
            ...
            modelBuilder.Entity("PrivateCloudDrive.FileCenter.UploadSession", b =>
                {
                    ...
                    b.Property<string>("UploadedChunksJson")
                        .IsRequired()
                        .HasMaxLength(16384)
                    ...
                    b.HasIndex("OwnerId", "ParentId", "NormalizedFileName");

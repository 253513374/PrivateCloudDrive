...
namespace PrivateCloudDrive.Migrations
{
    ...
    [Migration("20260508021008_AddedWechatUserBindings")]
    partial class AddedWechatUserBindings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PrivateCloudDrive.MobileAuth.WechatUserBinding", b =>
                {
                    ...
                    b.HasIndex("TenantId", "UnionId")
                        .IsUnique()
                        .HasDatabaseName("UX_WechatUserBindings_UnionId");

                    b.HasIndex("TenantId", "AppId", "OpenId")
                        .IsUnique()
                        .HasDatabaseName("UX_WechatUserBindings_AppId_OpenId");
